...
import com.a_ayush.blink.BlinkApplication;
...
public class HealthController {
    ...
    public String health() {
        long uptimeSeconds = Duration.between(BlinkApplication.START_TIME, Instant.now()).getSeconds();
        ...
        return """
                ...
                <head>
                  ...
                  <link rel="icon" href="https://blink-nr1z.onrender.com/assets/fav-BL9AkHD0.png" type="image/png">
                  <style>
                ...
                <body>
                  <div class='card'>
                    <img src='https://blink-nr1z.onrender.com/assets/fav-BL9AkHD0.png' class='icon'>
                    <h1>Server Status</h1>
